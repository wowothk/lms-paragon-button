      ...
      >
        {loading ? (
          <div style={{ textAlign: 'center', padding: '40px 20px' }}>
            ...
            <p style={{ marginTop: '20px', fontSize: '16px', textAlig: 'center' }}>Please wait for a moment.</p>
          </div>
        ) : success ? (
          <div style={{ textAlign: 'center', padding: '40px 20px' }}>
            <Alert variant="success" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '10px' }}>
